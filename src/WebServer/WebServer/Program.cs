...
namespace WebServer
{
    ...
    class Program
    {
        ...
        public static string SendResponse(HttpListenerRequest request)
        {
            ...
            {
                var fileNames = System.IO.Directory.GetFiles(@"C:\Users\Bill\nodejs\seismicimage\");
                ...
                foreach (var file in fileNames)
                {
                    ...
                    {
                        retNames.Add(Path.GetFileName(file));
                    }
                }
                return JsonConvert.SerializeObject(retNames, Formatting.Indented);
